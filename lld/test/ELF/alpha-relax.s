...
## local - (0x120000004 + 4) = 0x20, >> 2 = 8.
# CHECK-NEXT: 120000004: bsr $26, 8
...
## gpload + 8 - (0x12000000c + 4) = 0x24, >> 2 = 9.
# CHECK-NEXT: 12000000c: bsr $26, 9
...
## gpload - (0x120000018 + 4) = 0x10, >> 2 = 4.
# CHECK-NEXT: 120000018: bsr $26, 4
	ldq $27, gpload($29)	!literal
.Lbase:
	ldl $1, 0($27)
