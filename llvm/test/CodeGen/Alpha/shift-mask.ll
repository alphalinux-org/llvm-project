...
;
; Alpha shift instructions use only the low 6 bits of the shift amount.
; An AND mask whose low 6 bits are all 1 is redundant and is removed.
; A mask that clears any of those 6 bits is semantically meaningful and
; must be preserved.
