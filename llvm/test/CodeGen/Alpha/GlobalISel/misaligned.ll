...
; wrong bytes.  The legalizer's load rule names each entry's natural alignment
; and marks what is left unsupported, so this never reaches the selector at all
; -- see legalize-unsupported.mir.
