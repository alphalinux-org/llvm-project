...
; A comparison against zero is the branch itself: `sgt n, 0' taken the other
; way round is ble, and no compare instruction is emitted at all.  Which way
; the branch goes depends on how the blocks are laid out.
; CHECK-LABEL: branches:
; CHECK-NOT:  cmp
; CHECK:      b{{le|gt}} $16, {{\.LBB[0-9_]+}}
