...
; The three conditions with no instruction of their own and no swap that
; reaches one directly: each is the complementary comparison with the operands
; swapped, which is why none of them needs an xor to invert the result.
; CHECK-LABEL: sge:
; CHECK:       cmple $17, $16, $0
; CHECK-NEXT:  ret
