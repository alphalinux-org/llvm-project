...
; A 32-bit multiply takes the multiplier just as a 64-bit one does.  With mull
; unmapped it was modelled as a one-cycle operate with no functional unit, and
; the scheduler left it sitting behind the independent adds instead of starting
; it first.
