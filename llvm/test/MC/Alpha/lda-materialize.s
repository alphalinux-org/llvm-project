...
# The base can be left off: `lda $Rc, disp' is the same macro with $31 for the
# base.  GNU as assembles these to exactly these words.
# CHECK:      ldah $5, 4096($31)
# CHECK-NOT:  addq $5
	lda $5, 0x10000000

# CHECK:      ldah $6, 4660($31)
# CHECK-NEXT: lda $6, 22136($6)
	lda $6, 0x12345678

# A negative displacement outside the 16-bit field is materialized too.
# CHECK:      ldah $7, -1($31)
# CHECK-NEXT: lda $7, 25536($7)
	lda $7, -40000
