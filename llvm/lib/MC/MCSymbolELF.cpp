...
enum {
  ...
  // occupy bits 3-7 (bits 0-1 are visibility), e.g. Alpha's
  // STO_ALPHA_STD_GPLOAD (0x88) sets bit 3, so we shift right by 3 before
  // storing.
  ELF_STO_Shift = 7,
...
// MCSymbol::Flags is 16 bits wide and ELF_IsMemoryTagged_Shift is the last of
// them.  Adding another ELF symbol flag, or widening the st_other field, means
// growing MCSymbol::NumFlagsBits first -- which this cannot check for you,
// since NumFlagsBits is protected; it only pins the shift this file ends at.
