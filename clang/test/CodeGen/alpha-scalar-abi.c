...
// memory, judging a complex floating type by the width of one part rather than
// of the pair.  So __int128 and _Complex long come back through a hidden
// pointer, while _Complex float and _Complex double come back in $f0/$f1 and
// are passed in two floating-point argument registers.
